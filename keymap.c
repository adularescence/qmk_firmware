...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  /* 
	...
	* |-----------------------------------------------------------------------------------------+
	* |RGB  >  | Tog |Mode+|Mode-|Hue+ |Hue- |Sat+ |Sat- |Bri+ |Bri- |Eff+ |Eff- |      |       |
	* |-----------------------------------------------------------------------------------------+
	* |         |     |     |     | (F) |     |     | (J) |     |     |     |     |             |
	* |-----------------------------------------------------------------------------------------+
	* |      |     |     |     |     |     |     |     |     |     |     |     |Play/Pause|     |
	...
	*/
	[_FL] = LAYOUT(
		...
		_______,          RGB_TOG, RGB_MOD, RGB_RMOD,RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, RGB_VAI, RGB_VAD, RGB_SPI, RGB_SPD, _______, KC_GRV,
		...
		_______, _______,          _______,          _______, _______, _______,                   KC_MPRV, KC_MNXT, KC_MUTE, KC_VOLD, KC_VOLU
	)
};
