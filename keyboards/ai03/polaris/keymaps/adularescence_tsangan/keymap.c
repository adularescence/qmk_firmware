...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  /* 
	...
	* |-----------------------------------------------------------------------------------------|
	* |  Ctrl  | Win |  Alt  |                 Space                  |  Left  | Down |  Right  |
	* `-----------------------------------------------------------------------------------------'
	*/
  ...
  /* 
	...
	* |-----------------------------------------------------------------------------------------+
	* |  Caps   |Prev |Play |Next | (F) |     |     | (J) |Pause|Sleep|     |     |             |
	* |-----------------------------------------------------------------------------------------+
	* |RGB > |     | No |Breat|Rbow |Swirl|Snake|Knight|Xmax|SGrad|Test |     |   PgUp    |     |
	* |-----------------------------------------------------------------------------------------|
	* | Reset  |     |       |                                        |  Home |  PgDn |   End   |
	* `-----------------------------------------------------------------------------------------'
	*/
  [_FN] = LAYOUT_60_tsangan_hhkb(
    ...
    _______,          RGB_M_P, RGB_M_B, RGB_M_R, RGB_M_SW,RGB_M_SN,RGB_M_K, RGB_M_X, RGB_M_G, RGB_M_T, _______,          KC_PGUP, _______,
    RESET,   _______, _______,                                     _______,                                     KC_HOME, KC_PGDN, KC_END
  )
};
